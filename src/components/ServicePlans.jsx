        ...
        <div className={`transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
          ...
          <div className="flex flex-wrap justify-center mb-12 space-x-2 md:space-x-4">
            {categories.map((category) => (
              ...
              >
                <category.icon size={20} className={`mr-2 ${activeTab === category.id ? 'text-white' : 'text-blue-400'}`} />
                {category.name}
              </button>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services[activeTab].map((service, index) => (
              <div
                key={index}
                className={`bg-gradient-to-br from-gray-900/90 to-gray-950/90 backdrop-blur-lg rounded-2xl border border-gray-800 overflow-hidden transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-900/10 ${
              ...
              >
                <div className="p-8">
                  ...
                  <div className="space-y-3 mb-8">
                    {service.features.map((feature, idx) => (
                      <div key={idx} className="flex items-start">
                        <CheckCircle size={18} className="text-blue-400 mr-2 flex-shrink-0 mt-0.5" />
                  ...
                  <button 
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-blue-600/20 to-indigo-600/20 border border-blue-600/30 text-blue-300 flex items-center justify-center transition-all hover:from-blue-600/30 hover:to-indigo-600/30 group"
                  >
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-950/80 backdrop-blur-lg rounded-2xl border border-gray-800 p-8 max-w-3xl mx-auto">

        ...
        <div className={`transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
            {systems.map((system, index) => (
              <div 
                key={index}
                className={`relative rounded-2xl p-8 border group transition-all duration-500 
                  backdrop-blur-lg ${
                    theme === 'dark' 
                      ? 'bg-gradient-to-br from-gray-900/90 to-gray-950/90 border-gray-800 hover:from-gray-900/95 hover:to-gray-950/95' 
                      : 'bg-gradient-to-br from-gray-50/90 to-gray-100/90 border-gray-300 hover:from-gray-100/95 hover:to-gray-200/95'
                  }
